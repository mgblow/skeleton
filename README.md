...
For example, saving the above object using a repository (see below) you'll get a JSON document under the Redis key `models.com.cloudcatcity.platform.skeleton.Person:01FXD97WTHNYFQEA56YQ27BNQ6`:
